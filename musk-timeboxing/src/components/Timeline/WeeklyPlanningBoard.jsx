      ...
      <div className="grid gap-4 md:grid-cols-5">
        {days.map((day) => (
          <button
            ...
            className="ui-panel-subtle p-4 text-left transition-colors hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:hover:bg-slate-800"
