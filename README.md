...
할 일을 나열하는 데서 끝나지 않고, 실제 시간 블록으로 설계하는 데 집중한 local-first 플래너입니다.
...
일반적인 투두 앱은 할 일을 쌓는 데는 익숙하지만, 실제 시간을 배치하는 데는 약한 경우가 많습니다.

`Musk Time-Boxing Planner`는 아래 문제를 풀기 위해 만들었습니다.
